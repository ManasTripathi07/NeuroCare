...
// const mockImages = [
//   { id: 1, src: "https://thumbs.dreamstime.com/b/happy-man-thumbs-up-sign-full-length-portrait-white-background-showing-31416426.jpg", emotion: "Happiness" },
//   { id: 2, src: "https://www.shutterstock.com/shutterstock/photos/126009806/display_1500/stock-photo-portrait-of-a-sad-man-126009806.jpg", emotion: "Sadness" },
...
//   const [images, setImages] = useState(shuffleArray(mockImages));
...
//       if (selected !== null) {
//         if (selected === images[current].emotion) setScore((s) => s + 1);
//       }
...
//       {!showResult ? (
//         <div className="w-full max-w-xl p-6 rounded-2xl shadow-lg bg-richblack-700 space-y-6">
//           <motion.img
...
const EmotionRecognitionTest = () => {
  const [images, setImages] = useState(shuffleArray(onlineImages));
  const [current, setCurrent] = useState(0);
  const [selected, setSelected] = useState(null);
  const [score, setScore] = useState(0);
  const [showResult, setShowResult] = useState(false);
